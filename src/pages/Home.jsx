export default function Home({ scrollToProjects, scrollToContact, isOpen }) {
  return (
    <div className={`flex flex-col lg:flex-row items-center content-center ${isOpen ? "mt-64" : "mt-24"} lg:mt-96 justify-center`}>
